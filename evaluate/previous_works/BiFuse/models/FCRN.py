...
from previous_works.BiFuse.Utils.CubePad import CustomPad
import previous_works.Utils as Utils
from previous_works.Utils.CubePad import CustomPad
...
class UpProj(Decoder):
    ...
    def __init__(self, in_channels, padding):
        ...
        self.padding = getattr(previous_works.Utils.CubePad, padding)
...
class fusion_ResNet(nn.Module):
    ...
    def __init__(self, bs, layers, decoder, output_size=None, in_channels=3, pretrained=True, padding='ZeroPad'):
        ...
        self.padding = getattr(previous_works.BiFuse.Utils.CubePad, padding)
...
class MyModel(nn.Module):
    def __init__(self, layers, decoder, output_size=None, in_channels=3, pretrained=True):
        ...
        mypad = getattr(previous_works.Utils.CubePad, 'SpherePad')
